...
public class LeafyGreenVegetablesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leafy_green_vegetables);
    ...
    private void initGeneral() {
        currentActivity=LeafyGreenVegetablesActivity.this;
