...
public class AddingDinnerActivity extends AppCompatActivity {
    ...
    String currentDate,id;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_adding_dinner);
    ...
    private void initGeneral() {
        ...
        id=mAuth.getUid();
        myRef=database.getReference("Users/"+id+"/"+currentDate+"/Dinner");
        currentActivity=AddingDinnerActivity.this;
    }
    ...
    private void addDataToDB() {
        ...
        Dinner dinner=new Dinner(kindOfFoodText.getText().toString(),amountText.getText().toString(),amountKindText.getText().toString());
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                long dinnerLength = snapshot.getChildrenCount(); //Length of the menu

                if (dinnerLength>=4)//To ensure that menu can include maximum 4 kinds of food
                {
                ...
                for (DataSnapshot dp:snapshot.getChildren()) {
                    ...
                    if (map.get("kindOfFood").equals(dinner.kindOfFood))
                    {
